...
func NewRoutes(sql *sql.DB, helpers helpers.HelperBase) *InventoryRoutes {
	...
	return &InventoryRoutes{controller: controllers.NewInventoryController(inventoryService, helpers)}
}
